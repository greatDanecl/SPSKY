...
def generate_html(records, periods):
    ...
    JS = (
        ...
        '\n'
        '  // Comparison table\n'
        '  let tbl = \'<table class="comp-table"><thead><tr><th>Per\\u00edodo</th><th>Programado</th><th>Efectuado</th><th>Turnos prog.</th><th>Vuelos ef.</th><th>Conversi\\u00f3n</th><th>\\u0394 Block</th></tr></thead><tbody>\';\n'
        '  PERIODS.forEach(p => {\n'
        ...
        '    \'<div><div class="prog-head"><span class="prog-lbl">Horas Block acumuladas</span><span class="prog-num" style="color:var(--clay)">\' + accB.toFixed(0) + \'h</span></div><div class="prog-track"><div class="prog-fill" style="width:\' + pct1 + \'%;background:var(--clay)"></div></div><div class="prog-note">L\\u00edmite DAN 121: 1.000h/a\\u00f1o \\u00b7 \' + (100-pct1).toFixed(1) + \'% disponible</div></div>\' +\n'
        ...
        '  alerts += alrt(md>130?"danger":md>105?"warn":"ok", "Horas Duty \\u00b7 "+fmt(md)+"h", md>130?"Horas deber muy elevadas, revisar FDPs":md>105?"Sobre promedio del cargo":"Dentro de rango normal");\n'
    ...
    html = (
        ...
        '    <div class="nav-item"><svg fill="none" stroke="currentColor" stroke-width="1.6" viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>Horas Block</div>\n'
        '    <div class="nav-item"><svg fill="none" stroke="currentColor" stroke-width="1.6" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>Horas Duty</div>\n'
