...
def generate_html(records, periods):
    ...
    html = (
        ...
        '    <div class="nav-item"><svg fill="none" stroke="currentColor" stroke-width="1.6" viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>Horas BlockB</div>\n'
